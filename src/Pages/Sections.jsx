...
export default function Section(){
    ...
    return(
        <div className="h-screen overflow-y-scroll bg-white ">
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 md:grid-cols-3 lg:gap-0">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {quizdata !== null ? (
                            quizdata.map((eleme) => (
                                ...
                                <div className="mb-4 text-left pt-4 pl-2">
                                    <p className="text-gray-800">{eleme.name} 
                                        <a href="" className="text-blue-600">#tag</a>
                                    </p>
                                </div>
